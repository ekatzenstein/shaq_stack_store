...
export default class Orders extends Component {
    ...
    componentDidMount() {
        axios.get(`/api/admin/orders`).then(res => res.data).then(orders => {
            console.log(orders)
    ...
    _saveUpdates(e, i) {
        ...
        const id = order.id
        axios.put(`/api/admin/orders/${order.id}`, order).then(res => {}).catch(err => console.log(err));
    ...
    render() {
        const orders = this.state.orders && this.state.orders.filter(order => {
            //search order
        ...
        return (
            <div style={{width: '80%',margin: '0 auto'}}>
                ...
                <br/>
                Search order
                <input name="Search" onChange={this._searchOrder} style={{
                    marginLeft: '20px'
                }}/>
                <br/>
                <br/>
